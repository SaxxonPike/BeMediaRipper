...
Declare Function BASS_SetConfig Lib "bass23.dll" (ByVal opt As Long, ByVal value As Long) As Long
Declare Function BASS_GetConfig Lib "bass23.dll" (ByVal opt As Long) As Long
Declare Function BASS_GetVersion Lib "bass23.dll" () As Long
Declare Function BASS_GetDeviceDescription Lib "bass23.dll" (ByVal device As Long) As Long
Declare Function BASS_ErrorGetCode Lib "bass23.dll" () As Long
Declare Function BASS_Init Lib "bass23.dll" (ByVal device As Long, ByVal freq As Long, ByVal flags As Long, ByVal win As Long, ByVal clsid As Long) As Long
Declare Function BASS_SetDevice Lib "bass23.dll" (ByVal device As Long) As Long
Declare Function BASS_GetDevice Lib "bass23.dll" () As Long
Declare Function BASS_Free Lib "bass23.dll" () As Long
Declare Function BASS_GetDSoundObject Lib "bass23.dll" (ByVal object As Long) As Long
Declare Function BASS_GetInfo Lib "bass23.dll" (ByRef info As BASS_INFO) As Long
Declare Function BASS_Update Lib "bass23.dll" () As Long
Declare Function BASS_GetCPU Lib "bass23.dll" () As Single
Declare Function BASS_Start Lib "bass23.dll" () As Long
Declare Function BASS_Stop Lib "bass23.dll" () As Long
Declare Function BASS_Pause Lib "bass23.dll" () As Long
Declare Function BASS_SetVolume Lib "bass23.dll" (ByVal volume As Long) As Long
Declare Function BASS_GetVolume Lib "bass23.dll" () As Long

Declare Function BASS_PluginLoad Lib "bass23.dll" (ByVal filename As String, ByVal flags As Long) As Long
Declare Function BASS_PluginFree Lib "bass23.dll" (ByVal handle As Long) As Long
Private Declare Function BASS_PluginGetInfo_ Lib "bass23.dll" Alias "BASS_PluginGetInfo" (ByVal handle As Long) As Long

Declare Function BASS_Set3DFactors Lib "bass23.dll" (ByVal distf As Single, ByVal rollf As Single, ByVal doppf As Single) As Long
Declare Function BASS_Get3DFactors Lib "bass23.dll" (ByRef distf As Single, ByRef rollf As Single, ByRef doppf As Single) As Long
Declare Function BASS_Set3DPosition Lib "bass23.dll" (ByRef pos As Any, ByRef vel As Any, ByRef front As Any, ByRef top As Any) As Long
Declare Function BASS_Get3DPosition Lib "bass23.dll" (ByRef pos As Any, ByRef vel As Any, ByRef front As Any, ByRef top As Any) As Long
Declare Function BASS_Apply3D Lib "bass23.dll" () As Long
Declare Function BASS_SetEAXParameters Lib "bass23.dll" (ByVal env As Long, ByVal vol As Single, ByVal decay As Single, ByVal damp As Single) As Long
Declare Function BASS_GetEAXParameters Lib "bass23.dll" (ByRef env As Long, ByRef vol As Single, ByRef decay As Single, ByRef damp As Single) As Long

Declare Function BASS_MusicLoad Lib "bass23.dll" (ByVal mem As Long, ByVal f As Any, ByVal offset As Long, ByVal length As Long, ByVal flags As Long, ByVal freq As Long) As Long
Declare Function BASS_MusicFree Lib "bass23.dll" (ByVal handle As Long) As Long
Declare Function BASS_MusicSetAttribute Lib "bass23.dll" (ByVal handle As Long, ByVal attrib As Long, ByVal value As Long) As Long
Declare Function BASS_MusicGetAttribute Lib "bass23.dll" (ByVal handle As Long, ByVal attrib As Long) As Long
Declare Function BASS_MusicGetOrders Lib "bass23.dll" (ByVal handle As Long) As Long
Declare Function BASS_MusicGetOrderPosition Lib "bass23.dll" (ByVal handle As Long) As Long

Declare Function BASS_SampleLoad Lib "bass23.dll" (ByVal mem As Long, ByVal f As Any, ByVal offset As Long, ByVal length As Long, ByVal max As Long, ByVal flags As Long) As Long
Declare Function BASS_SampleCreate Lib "bass23.dll" (ByVal length As Long, ByVal freq As Long, ByVal chans As Long, ByVal max As Long, ByVal flags As Long) As Long
Declare Function BASS_SampleCreateDone Lib "bass23.dll" () As Long
Declare Function BASS_SampleFree Lib "bass23.dll" (ByVal handle As Long) As Long
Declare Function BASS_SampleGetInfo Lib "bass23.dll" (ByVal handle As Long, ByRef info As BASS_SAMPLE) As Long
Declare Function BASS_SampleSetInfo Lib "bass23.dll" (ByVal handle As Long, ByRef info As BASS_SAMPLE) As Long
Declare Function BASS_SampleGetChannel Lib "bass23.dll" (ByVal handle As Long, ByVal onlynew As Long) As Long
Declare Function BASS_SampleStop Lib "bass23.dll" (ByVal handle As Long) As Long

Declare Function BASS_StreamCreate Lib "bass23.dll" (ByVal freq As Long, ByVal chans As Long, ByVal flags As Long, ByVal proc As Long, ByVal user As Long) As Long
Declare Function BASS_StreamCreateFile Lib "bass23.dll" (ByVal mem As Long, ByVal f As Any, ByVal offset As Long, ByVal length As Long, ByVal flags As Long) As Long
Declare Function BASS_StreamCreateURL Lib "bass23.dll" (ByVal url As String, ByVal offset As Long, ByVal flags As Long, ByVal proc As Long, ByVal user As Long) As Long
Declare Function BASS_StreamCreateFileUser Lib "bass23.dll" (ByVal buffered As Long, ByVal flags As Long, ByVal proc As Long, ByVal user As Long) As Long
Declare Function BASS_StreamFree Lib "bass23.dll" (ByVal handle As Long) As Long
Declare Function BASS_StreamGetFilePosition Lib "bass23.dll" (ByVal handle As Long, ByVal mode As Long) As Long

Declare Function BASS_RecordGetDeviceDescription Lib "bass23.dll" (ByVal device As Long) As Long
Declare Function BASS_RecordInit Lib "bass23.dll" (ByVal device As Long) As Long
Declare Function BASS_RecordSetDevice Lib "bass23.dll" (ByVal device As Long) As Long
Declare Function BASS_RecordGetDevice Lib "bass23.dll" () As Long
Declare Function BASS_RecordFree Lib "bass23.dll" () As Long
Declare Function BASS_RecordGetInfo Lib "bass23.dll" (ByRef info As BASS_RECORDINFO) As Long
Declare Function BASS_RecordGetInputName Lib "bass23.dll" (ByVal inputn As Long) As Long
Declare Function BASS_RecordSetInput Lib "bass23.dll" (ByVal inputn As Long, ByVal setting As Long) As Long
Declare Function BASS_RecordGetInput Lib "bass23.dll" (ByVal inputn As Long) As Long
Declare Function BASS_RecordStart Lib "bass23.dll" (ByVal freq As Long, ByVal chans As Long, ByVal flags As Long, ByVal proc As Long, ByVal user As Long) As Long

Private Declare Function BASS_ChannelBytes2Seconds64 Lib "bass23.dll" Alias "BASS_ChannelBytes2Seconds" (ByVal handle As Long, ByVal pos As Long, ByVal poshigh As Long) As Single
Declare Function BASS_ChannelSeconds2Bytes Lib "bass23.dll" (ByVal handle As Long, ByVal pos As Single) As Long
Declare Function BASS_ChannelGetDevice Lib "bass23.dll" (ByVal handle As Long) As Long
Declare Function BASS_ChannelSetDevice Lib "bass23.dll" (ByVal handle As Long, ByVal device As Long) As Long
Declare Function BASS_ChannelIsActive Lib "bass23.dll" (ByVal handle As Long) As Long
Declare Function BASS_ChannelGetInfo Lib "bass23.dll" (ByVal handle As Long, ByRef info As BASS_CHANNELINFO) As Long
Declare Function BASS_ChannelGetTags Lib "bass23.dll" (ByVal handle As Long, ByVal tags As Long) As Long
Declare Function BASS_ChannelSetFlags Lib "bass23.dll" (ByVal handle As Long, ByVal flags As Long) As Long
Declare Function BASS_ChannelPreBuf Lib "bass23.dll" (ByVal handle As Long, ByVal length As Long) As Long
Declare Function BASS_ChannelPlay Lib "bass23.dll" (ByVal handle As Long, ByVal restart As Long) As Long
Declare Function BASS_ChannelStop Lib "bass23.dll" (ByVal handle As Long) As Long
Declare Function BASS_ChannelPause Lib "bass23.dll" (ByVal handle As Long) As Long
Declare Function BASS_ChannelSetAttributes Lib "bass23.dll" (ByVal handle As Long, ByVal freq As Long, ByVal volume As Long, ByVal pan As Long) As Long
Declare Function BASS_ChannelGetAttributes Lib "bass23.dll" (ByVal handle As Long, ByRef freq As Long, ByRef volume As Long, ByRef pan As Long) As Long
Declare Function BASS_ChannelSlideAttributes Lib "bass23.dll" (ByVal handle As Long, ByVal freq As Long, ByVal volume As Long, ByVal pan As Long, ByVal time As Long) As Long
Declare Function BASS_ChannelIsSliding Lib "bass23.dll" (ByVal handle As Long) As Long
Declare Function BASS_ChannelSet3DAttributes Lib "bass23.dll" (ByVal handle As Long, ByVal mode As Long, ByVal min As Single, ByVal max As Single, ByVal iangle As Long, ByVal oangle As Long, ByVal outvol As Long) As Long
Declare Function BASS_ChannelGet3DAttributes Lib "bass23.dll" (ByVal handle As Long, ByRef mode As Long, ByRef min As Single, ByRef max As Single, ByRef iangle As Long, ByRef oangle As Long, ByRef outvol As Long) As Long
Declare Function BASS_ChannelSet3DPosition Lib "bass23.dll" (ByVal handle As Long, ByRef pos As Any, ByRef orient As Any, ByRef vel As Any) As Long
Declare Function BASS_ChannelGet3DPosition Lib "bass23.dll" (ByVal handle As Long, ByRef pos As Any, ByRef orient As Any, ByRef vel As Any) As Long
Declare Function BASS_ChannelGetLength Lib "bass23.dll" (ByVal handle As Long) As Long
Private Declare Function BASS_ChannelSetPosition64 Lib "bass23.dll" Alias "BASS_ChannelSetPosition" (ByVal handle As Long, ByVal pos As Long, ByVal poshigh As Long) As Long
Declare Function BASS_ChannelGetPosition Lib "bass23.dll" (ByVal handle As Long) As Long
Declare Function BASS_ChannelGetLevel Lib "bass23.dll" (ByVal handle As Long) As Long
Declare Function BASS_ChannelGetData Lib "bass23.dll" (ByVal handle As Long, ByRef buffer As Any, ByVal length As Long) As Long
Private Declare Function BASS_ChannelSetSync64 Lib "bass23.dll" Alias "BASS_ChannelSetSync" (ByVal handle As Long, ByVal atype As Long, ByVal param As Long, ByVal paramhigh As Long, ByVal proc As Long, ByVal user As Long) As Long
Declare Function BASS_ChannelRemoveSync Lib "bass23.dll" (ByVal handle As Long, ByVal sync As Long) As Long
Declare Function BASS_ChannelSetDSP Lib "bass23.dll" (ByVal handle As Long, ByVal proc As Long, ByVal user As Long, ByVal priority As Long) As Long
Declare Function BASS_ChannelRemoveDSP Lib "bass23.dll" (ByVal handle As Long, ByVal dsp As Long) As Long
Declare Function BASS_ChannelSetEAXMix Lib "bass23.dll" (ByVal handle As Long, ByVal mix As Single) As Long
Declare Function BASS_ChannelGetEAXMix Lib "bass23.dll" (ByVal handle As Long, ByRef mix As Single) As Long
Declare Function BASS_ChannelSetLink Lib "bass23.dll" (ByVal handle As Long, ByVal chan As Long) As Long
Declare Function BASS_ChannelRemoveLink Lib "bass23.dll" (ByVal handle As Long, ByVal chan As Long) As Long
Declare Function BASS_ChannelSetFX Lib "bass23.dll" (ByVal handle As Long, ByVal atype As Long, ByVal priority As Long) As Long
Declare Function BASS_ChannelRemoveFX Lib "bass23.dll" (ByVal handle As Long, ByVal fx As Long) As Long
Declare Function BASS_FXSetParameters Lib "bass23.dll" (ByVal handle As Long, ByRef par As Any) As Long
Declare Function BASS_FXGetParameters Lib "bass23.dll" (ByVal handle As Long, ByRef par As Any) As Long
